...
__all__ = ['DyHeadBlock', 'DyHeadBlockWithDCNV3', 'Fusion', 'C3k2_Faster', 'C3k2_ODConv', 'Partial_conv3', 'C3k2_Faster_EMA', 'C3k2_DBB',
           ...
           'C3k2_DynamicFilter', 'C3k2_TSSA', 'A2C2f_CGLU', 'A2C2f_KAN', 'A2C2f_DFFN', 'HAFB', 'A2C2f_FRFN', 'C3k2_SAVSS', 'C3k2_MobileMamba', 'C3k2_MambaOut'
           ]
...
class RGCSPELAN(nn.Module):
    def __init__(self, c1, c2, n=1, scale=0.5, e=0.5):
        ...
        self.c = int(c2 * e)  # hidden channels  c2/2
        self.mid = int(self.c * scale)  # c2/4

        self.cv1 = Conv(c1, 2 * self.c, 1, 1)  # c1 to c2
        self.cv2 = Conv(self.c + self.mid * (n + 1), c2, 1)

        self.cv3 = RepConv(self.c, self.mid, 3)  # c2/2 to c2/4
