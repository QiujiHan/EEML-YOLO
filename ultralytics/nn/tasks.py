...
def parse_model(d, ch, verbose=True, warehouse_manager=None):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in ((
            ...
            MANet_Star, PSConv, C2Pola, A2C2f, C2TSSA, A2C2f_CGLU, A2C2f_KAN, A2C2f_DFFN, RepHMS, A2C2f_FRFN, C2ASSA
        ) + C3K2_CLASS):
            if args[0] == 'head_channel':
                args[0] = d[args[0]]
            c1, c2 = ch[f], args[0]
            ...
            if m in ((
                ...
                MANet_FasterBlock, MANet_FasterCGLU, MANet_Star, C2Pola, A2C2f, C2TSSA, A2C2f_CGLU, A2C2f_KAN, A2C2f_DFFN, A2C2f_FRFN, C2ASSA
            ) + C3K2_CLASS):
